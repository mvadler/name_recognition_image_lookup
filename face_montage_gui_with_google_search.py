...
if IN_COLAB:
    # If running in Colab, disable Tkinter and run headless logic
    print("Running in Colab, skipping Tkinter GUI...")
    
    # Here, you can directly run the face recognition or other logic you want to test
    text = "Some input text for face matching"
    # Call your face matching function or whatever is necessary
    main(text, status_callback=lambda message: print(message))  # Modify to print status in Colab
else:
    # Else, run the Tkinter GUI as usual
